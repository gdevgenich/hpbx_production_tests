...
fpm   --name "$DEB_PACKAGE_NAME" \
      ...
      --depends 'python3-hpbx-base = 2.85' \
      ...
      --depends 'libpjproject 2.11' \
      --depends 'sipde-ng 1.2.3' \
      --depends 'sipmon-ng 2.4.12' \
